...
@section('content')
    ...
    <div class="container-fluid" style="padding:0 !important;">
            <ul>
                <li>
                    <!-- MAIN IMAGE -->
                    <img class="img-responsive" style="width:100%;" src="{{asset('img/banner/contact_us.jpg')}}" alt="slidebg1">
                </li>
            </ul>
    </div>
		...
		<div class="content row_spacer no_padding">	
			<div class="rows_container clearfix">
				...
				<div class="col-md-offset-2 col-md-8 col-sm-12 text-center">
					<h2 class="title1 upper">Get A Quote Or Request Free Consultation Now  </h2>
				    <div class="col-md-12">
